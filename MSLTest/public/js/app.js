...
var render = function() {
  ...
  return _c("div", { staticClass: "container" }, [
    _c("div", { staticClass: "card-body" }, [
      _c(
        "form",
        { staticClass: "form-inline", on: { submit: _vm.formSubmit } },
        [
          _c("div", { staticClass: "form-group" }, [
            _c("strong", [_vm._v("room type id:")]),
            _vm._v(" "),
            _c(
              "select",
              {
                directives: [
                  {
                    name: "model",
                    rawName: "v-model",
                    value: _vm.room_type_id,
                    expression: "room_type_id"
                  }
                ],
                ...
                on: {
                  change: function($event) {
                    ...
                    _vm.room_type_id = $event.target.multiple
                      ? $$selectedVal
                      : $$selectedVal[0]
                  }
                }
...
Vue.component('show-room', __webpack_require__(/*! ./components/Room.vue */ "./resources/js/components/Room.vue")["default"]);
var app = new Vue({
  el: '#app'
});
...
__webpack_require__(/*! C:\xampp\htdocs\MSL\MSLTest\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\xampp\htdocs\MSL\MSLTest\resources\sass\app.scss */"./resources/sass/app.scss");
